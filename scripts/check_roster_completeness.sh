...
#
# EXEMPTIONS ARE EXPLICIT AND MUST CARRY A REASON. There are exactly two kinds:
# a paired control whose whole job is to fail (batch_verifier_race_control), and
# a target whose source no longer exists. Both are listed below with the reason
# inline. An exemption without a reason is a hole with a nicer name.
# ============================================================================
set -uo pipefail
